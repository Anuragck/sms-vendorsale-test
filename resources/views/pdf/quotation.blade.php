...
<body>
                    ...
                    <table class="table table-bordered mb-5" width="100%" style="margin-bottom: 0">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="2">
                                    Dated :
                                    <b>{{ Carbon\Carbon::parse($quotation->quotation_date)->format('d-M-Y') }}</b>
                                    <br />
                                    <br />
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3" align="right" class="items-ftr">
                                <b>{{ $quotation->total_amount }} </b>
                            </td>
                        </tr>
                        @php
                            $f = new NumberFormatter('en', NumberFormatter::SPELLOUT);
                            $amount_in_words = $f->format($quotation->pay_amount);
                        @endphp
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3" align="right" style="border: 0">
                                <span>{{ $quotation->total_discount }} </span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="12" style="border: 0">Round Off</td>
                            <td colspan="3" align="right" style="border: 0">
                                <span>{{ $quotation->roundoff }}</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" align="right" style="border: 0">
                                <b> <span> {{ $quotation->pay_amount }} /-</span></b>
                            </td>
                        </tr>

                        <tr>
                        <td colspan="15" align="center" style="border: 0">
                       <b> Quotation Valid Till {{ Carbon\Carbon::parse($quotation->quotation_end_date)->format('d-M-Y') }}</b>
                        </td>
                        </tr>
    ...
    @if ($gst == 1)
        <div class="container">
            <div id="canvas_div_pdf">
                <div class="text-center">
                    <h6 style="text-align: center;">GST quotation</h6>
                </div>
                ...
                <table class="table table-bordered mb-5" width="100%" style="margin-bottom: 0">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="14">
                                ...
                                <b>{{ $quotation->customer->name }}</b> <br />
                                {{ $quotation->customer->mobile }} <br />
                                @if ($quotation->customer->gst_no != null)
                                    <span>GSTIN/UIN :{{ $quotation->customer->gst_no }}</span>
                                @endif
                                <br />
                            </td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="1" align="right" class="items-tr">
                            <b>{{ $quotation->total_taxable_amount }}</b>
                        </td>
                        <td colspan="2" align="center" class="items-tr">
                            <b>{{ $quotation->total_sgst }}</b>
                        </td>
                        <td colspan="2" align="center" class="items-tr">
                            <b>{{ $quotation->total_cgst }}</b>
                        </td>
                        <td colspan="2" align="center" class="items-tr">
                            <b>{{ $quotation->total_cess }}</b>
                        </td>
                        <td colspan="1" align="right" class="items-tr">
                            <b>{{ $quotation->total_cgst + $quotation->total_sgst }} </b>
                        </td>
                        <td colspan="1" align="right" class="items-tr">
                            <b>{{ $quotation->total_amount }}</b>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="right" style="border: 0">
                            {{ $quotation->total_taxable_amount }}
                        </td>
                    </tr>
