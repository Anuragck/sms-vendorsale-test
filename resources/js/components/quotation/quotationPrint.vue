<template>
    <div>
        <div class="modal-header bg-primary">
            <h5 class="modal-title modal-title-custom" id="quotationlabel">
                {{ "Quotation" }}
            </h5>
            <button
                type="button"
        ...
        <div class="modal-body">
            <div class="text-right">
                <span class="text-muted">Share Quotation To:</span>
                ...
                <ShareNetwork
                    ...
                    :url="sharing_link + quotation_no + '&gst_bill=' + gst_bill"
                    :title="
                        'Hello ' + billCustomer.name + ' here is your quotation'
                    "
                ...
                >
                    ...
                    <i
                        ...
                        v-if="thermalPrintLoading == false"
                    ></i
                    ><i
                        ...
                        <div class="ticket">
                            <div class="row text-center">
                                <div class="col">
                                    ...
                                    <span style=""
                                        >Customer:
                                        {{ billCustomer.name }} </span
                                    ><span class="ml-1">
                                        Ph: {{ billCustomer.mobile }} </span
                                    ><br />
                                    <span
                                        v-if="
                                            billCustomer.gst_no != '' &&
                                    ...
                                    <span style="inline-block"
                                        >Quotation No: {{ quotation_no }} </span
                                    ><span class="ml-1">
                                        Date: {{ quotation_date | myDate }}
                                    </span>
                                </div>
                            </div>

                            <table
                                class="table-center table table-sm pb-0 mb-0"
                            >
                                <thead class="">
                                    <tr>
                            ...
                            ><br />
                            <span class="float-right"
                                >Round Off : {{ roundoff }}</span
                            ><br />
                            <span class="float-right">
                                <b
                                    >Total Amount To Pay : {{ pay_amount }}
                                </b></span
                            ><br />
                           
                            <div class="text-center pt-3">
                                <p><b> This quotation is valid till <br>{{ quotation_end_date | myDate }} </b></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="canvas_div_pdf">
                    ...
                    <tr>
                               <td  colspan="14"
                                    ...
                                    <b> This quotation is valid till {{ quotation_end_date | myDate }} </b>
                                </td>
                            </tr>
...
export default {
    data() {
        return {
            sharing_link: "http://sms.test/get-quotation?id=",
            printLoading: false,
            ...
            sharing: {
                // title: 'Hello '+billCustomer.name+ 'here is your invoice',
                description:
                    "Please go through this link to download, Thank you.",
            },
            ...
            networks: [
                {
                    network: "email",
                    name: "Email",
                    icon: "far fah fa-lg fa-envelope ml-1 hover-my-icon",
                    color: "#FF5647",
                },
                {
                    network: "whatsapp",
                    name: "Whatsapp",
                    icon: "fab fah fa-lg fa-whatsapp ml-1 hover-my-icon",
                    color: "#25D366",
                },
            ],
        };
    ...
    methods: {
        ...
        clickPdf() {
            ...
            var opt = {
                margin: 0.25,
                filename: "Quotation_" + _this.quotation_no,
    ...
    created() {
        ...
        bus.$on("quotation-print", function (quotation) {
            _this.billCustomer = quotation.customer;
            // _this.billItems=sale.items;
            _this.gst_bill = quotation.gst_bill;
            _this.bill_type = quotation.bill_type;
            _this.quotation_date = quotation.quotation_date;
             _this.quotation_end_date = quotation.quotation_end_date;
            _this.quotation_no = quotation.quotation_no;
            _this.pay_amount = quotation.pay_amount;
            _this.total_amount = quotation.total_amount;
            _this.total_discount = quotation.total_discount;

            _this.roundoff = quotation.roundoff;

            //gst-bill
            _this.total_taxable_amount = quotation.total_taxable_amount;
            _this.total_cgst = quotation.total_cgst;
            _this.total_sgst = quotation.total_sgst;
            _this.total_cess = quotation.total_cess;
            ...
            _this.total_pay_amount_words = toWords.convert(quotation.pay_amount);
            ...
            for (let item in quotationItems) {
                ...
                var total_rate = quotationItems[item].total_rate;

                //GST-BILL
                var taxable_value = quotationItems[item].taxable_amount;
                var gst = quotationItems[item].gst;
                var sgst_amount = quotationItems[item].sgst;
                var cgst_amount = quotationItems[item].cgst;
                var total_cess = quotationItems[item].total_cess;
